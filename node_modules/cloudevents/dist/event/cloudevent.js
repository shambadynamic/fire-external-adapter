...
class CloudEvent {
    ...
    constructor(event, strict = true) {
        _CloudEvent__data.set(this, void 0);
...
See: https://github.com/cloudevents/spec/blob/v1.0/spec.md#type-system`);
    ...
    get data() {
        return __classPrivateFieldGet(this, _CloudEvent__data, "f");
    }
    set data(value) {
        if (validation_1.isBinary(value)) {
            this.data_base64 = validation_1.asBase64(value);
        }
        __classPrivateFieldSet(this, _CloudEvent__data, value, "f");
    }
    /**
    ...
    toJSON() {
        ...
        event.data = __classPrivateFieldGet(this, _CloudEvent__data, "f");
        return event;
    }
    toString() {
     ...
     */
    [(_CloudEvent__data = new WeakMap(), Symbol.for("nodejs.util.inspect.custom"))]() {
