    ...
    axios
        ...
        .then(res => {
            if (res.status == 200) {
                ...
                var agg_fire_detected = res.data['data']['agg_fire_detected']
                if (agg_fire_detected == 0) {
                    agg_fire_detected = 9
                }
                res.data.result = agg_fire_detected
                var is_fire_detected = false
                if (agg_fire_detected == 1) {
